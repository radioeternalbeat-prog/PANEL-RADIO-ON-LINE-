...
export default function PanelMicrofonos() {
  ...
  // --- Mapeo MIDI: alterna el mute global de todos los micrófonos (el
  // equivalente más cercano al antiguo "mezclador.mic" de un solo micro).
  useMidiTarget("mezclador.mic", () => alternarSilencio());
